        ...
        <section id = "home" className="min-h-screen flex items-center justify-center relative">
            <div className="text-center z-10 px-4">
                ...
                <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                    ...
                    applications. My goals is to build solutions that offer both
                    exceptional perfromance and a delightful user experience.

                   
                </p>

                <p className="text-gray-200 text-lg mb-8 max-w-lg mx-auto">
                     Computer Science 2024 at Western University 
                </p>

                <div className="flex justify-center space-x-4">
                    <a href="#projects" className="bg-blue-500 text-white py-3 px-5 rounded font-medium transition relative 
